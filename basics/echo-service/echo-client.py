...
# 
#El archivo se compila despues de compilar el servidor con el comando:
#python echo-server.py --port NUM_PORT y despues:
#python echo-client.py --port NUM_PORT
...
def echo_client(port):
    ...
    try:
        ...
        print 'fallo creacion socket.Error code:'+ str(msg[0])+',msg:'+ str(msg[1])
    ...
    try:
        ...
        # tu codigo aqui
        message = raw_input("digite un texto: ")
